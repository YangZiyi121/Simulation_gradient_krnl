...
module tcp_top_loopback #(
   ...
   (* mark_debug = "true" *) wire[31:0] maxis_meta_data;   
...
(
  ...
  //assign   maxis_tx_data = finalOutData[31+64:64];
   assign   m_axis_tx_data_TKEEP = 64'hF;
   assign   maxis_tx_last = finalOutValid & finalOutLast;
   
   assign   finalOutReady = maxis_meta_ready & maxis_tx_ready;
   
   //packet length
   assign   maxis_meta_data = {16'h4, finalOutData[15:0]};
   assign   maxis_meta_valid = finalOutValid & finalOutReady;
